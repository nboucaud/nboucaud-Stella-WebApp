            ...
            <div className='form-row'>
                ...
                <div className='form-row-third-2'>
                    <Input
                        ...
                        placeholder={messages.postalCode}
                        required={true}
                    />
                </div>
            </div>
                        ...
                        <div className='CompanyInfoEdit__form'>
                            ...
                            <div className='form-row'>
                                <Input
                                    ...
                                    placeholder={messages.numEmployees}
                                />
                            </div>
                            <div className='section-title'>
                                <FormattedMessage
...
const messages = defineMessages({
    address: {
        id: 'admin.billing.company_info.address',
        defaultMessage: 'Address',
    },
    address2: {
        id: 'admin.billing.company_info.address_2',
        defaultMessage: 'Address 2',
    },
    city: {
        id: 'admin.billing.company_info.city',
        defaultMessage: 'City',
    },
    companyName: {
        id: 'admin.billing.company_info.companyName',
        defaultMessage: 'Company name',
    },
    numEmployees: {
        id: 'admin.billing.company_info.numEmployees',
        defaultMessage: 'Number of employees (optional)',
    },
    postalCode: {
