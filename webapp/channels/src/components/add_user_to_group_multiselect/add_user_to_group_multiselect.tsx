...
export class AddUserToGroupMultiSelect extends React.PureComponent<Props, State> {
    ...
    public render = (): JSX.Element => {
        const buttonSubmitText = this.props.buttonSubmitText || messages.createGroup;
        const buttonSubmitLoadingText = this.props.buttonSubmitLoadingText || messages.creating;
        ...
        if (this.state.values.length >= MAX_SELECTABLE_VALUES) {
            ...
            numRemainingText = messages.maxGroupMembers;
        }
...
const messages = defineMessages({
    createGroup: {id: 'multiselect.createGroup', defaultMessage: 'Create Group'},
    creating: {id: 'multiselect.creating', defaultMessage: 'Creating...'},
    maxGroupMembers: {
        id: 'multiselect.maxGroupMembers',
        defaultMessage: 'No more than 256 members can be added to a group at once.',
    },
    placeholder: {id: 'multiselect.placeholder', defaultMessage: 'Search for people'},
});
